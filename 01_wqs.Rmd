...
The following WQS do not follow the logic depicted in Figure \@ref(fig:wqs-general-use). It is important to specifically document all discrepancies because these instances will require special attention while developing an automated process to perform assessments.
